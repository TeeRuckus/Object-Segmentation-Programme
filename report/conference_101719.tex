...
Harris corner detection is an algorithm which can be mainly thought as a rotation invariant algorithm
\subsection{SIFT}
%----------------------------------------------------------------------------------------
%things whihc came with the conference paper, and I think they're useful so I am going to
%leave them here for the time being
%----------------------------------------------------------------------------------------
\section{Task Two} \label{two}
...
acknowledgments in the unnumbered footnote on the first page. How is this going to work
...
%citation first, followed by the original foreign-language citation \cite{b6}. This is something which was said from king Kwaramba \cite{b8}
...
%\bibitem{b8} Tawana David Kwaramba is the great king which lived happily after in his castle all this time
\end{thebibliography}
